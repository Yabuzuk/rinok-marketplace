      ...
      case 'terms':
        return (
          <div style={{ maxHeight: '600px', overflowY: 'auto', padding: '20px' }}>
            ...
            <p>5.1. Споры разрешаются путем переговоров.</p>
            <p>5.2. При невозможности соглашения – в Арбитражном суде г. Москва.</p>
      ...
      case 'offer':
        return (
          <div style={{ maxHeight: '600px', overflowY: 'auto', padding: '20px' }}>
            ...
            <p>6.1. Споры разрешаются путем переговоров.</p>
            <p>6.2. При невозможности соглашения – в Арбитражном суде г. Москва.</p>
